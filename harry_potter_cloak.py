...
cv2.createTrackbar("lower_hue","bars",69,180,hello)
cv2.createTrackbar("lower_saturation","bars",55,255,hello)
cv2.createTrackbar("lower_value","bars",55,255,hello)
...
while True:
    ...
    blan_area=cv2.merge((b,g,r))

    final=cv2.bitwise_or(frame_inv,blan_area)
